...
/** default number of sampled intervals per octave 每一组分的层数*/
#define SIFT_INTVLS 3

/** default sigma for initial gaussian smoothing sigma初始值*/
#define SIFT_SIGMA 1.6

/** default threshold on keypoint contrast |D(x)| 对比度最小值限制*/
#define SIFT_CONTR_THR 0.04

/** default threshold on keypoint ratio of principle curvatures  关键点处曲率比值最大值限制*/
#define SIFT_CURV_THR 10

/** double image size before pyramid construction? 是否扩大两倍图像作为初始层*/
#define SIFT_IMG_DBL 1

/** default width of descriptor histogram array 描述子直方图矩阵默认尺寸*/
#define SIFT_DESCR_WIDTH 4

/** default number of bins per histogram in descriptor array 描述子直方图默认方向份数*/
#define SIFT_DESCR_HIST_BINS 8

/* assumed gaussian blur for input image 假定初始模糊度*/
...
/* determines gaussian sigma for orientation assignment 分配方向时高斯权重参数因子*/
#define SIFT_ORI_SIG_FCTR 1.5

/* determines the radius of the region used in orientation assignment 分配方向时计算区域大小，根据3sigma外可忽略*/
#define SIFT_ORI_RADIUS 3.0 * SIFT_ORI_SIG_FCTR

/* number of passes of orientation histogram smoothing */
#define SIFT_ORI_SMOOTH_PASSES 2

/* orientation magnitude relative to max that results in new feature 分配方向时副方向相对主方向幅值的比例阈值*/
#define SIFT_ORI_PEAK_RATIO 0.8

/* determines the size of a single descriptor orientation histogram */
#define SIFT_DESCR_SCL_FCTR 3.0

/* threshold on magnitude of elements of descriptor vector 描述向量元素最大阈值*/
